...
from nautilus_ctp_adapter.diagnostics.guarded_paper_cancel import (
    BASELINE,
...
def _run_native_cancel_action(
    *,
    ...
    try:
        ...
        return build_native_cancel_unavailable_payload(
    ...
    try:
        ...
        if login is None or not getattr(login, "success", False):
            return build_native_cancel_login_failed_payload(
                init_code=init_code,
        ...
        if settlement_code != 0:
            return build_native_cancel_settlement_failed_payload(
        ...
        return build_native_cancel_action_payload(
