...
| --- | --- | --- | --- | --- | --- |
| P1 | Freeze the live-config contract and secret-loading rule for account `025292` | `docs/topics/roadmap/nautilus_adapter/ctp-live-connectivity/README.md`, `docs/changes/20260401__ctp-live-connectivity__login-025292-and-subscribe-rb2610/*`, `src/nautilus_ctp_adapter/adapters/ctp/config.py`, `cfgs/ctp.live.example.json` | Tracked config schema plus documented untracked secret source | `python -m pytest` | Completed |
