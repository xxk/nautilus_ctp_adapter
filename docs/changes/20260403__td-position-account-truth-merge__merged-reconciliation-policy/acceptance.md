# Merged Reconciliation Policy 验收方案 / Acceptance Plan

**模板标识 / Template Marker**：standard
**变更目录 / Change Root**：./
**状态**：✅ 通过
**日期**：2026-04-02
**范围**：merged reconciliation policy
...
1. 冻结 merged truth 的 reconciliation policy。
...
| --- | --- | --- | --- | --- | --- | --- |
| A1 | Success 1: live merged policy smoke 成功 | 运行 `ctp_td_merged_reconciliation_policy_smoke.py` | 返回 0 | smoke 正常退出 | 返回非 0 | [evidence_20260402_merged_reconciliation_policy.md](./evidence_20260402_merged_reconciliation_policy.md) |
| A2 | Success 2: baseline version 稳定 | 检查 smoke JSON | `baseline=td-merged-reconciliation-policy-v1` | policy 结构固定 | 无 baseline 或结构漂移 | [evidence_20260402_merged_reconciliation_policy.md](./evidence_20260402_merged_reconciliation_policy.md) |
| A3 | Success 3: merged truth risk bucket 稳定 | 检查 smoke JSON | 输出 `disposition/findings` | merged policy 可直接消费 | 只有原始 snapshot 没有 policy 结论 | [evidence_20260402_merged_reconciliation_policy.md](./evidence_20260402_merged_reconciliation_policy.md) |
