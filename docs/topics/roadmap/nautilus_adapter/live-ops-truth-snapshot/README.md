...
**最后更新**：2026-04-02
**状态**：进行中
**进度**：C2 active（live retry blocked by unstable disconnect storm）
...
1. [td-position-account-truth-merge](/D:/Nautilus/nautilus_ctp_adapter/docs/topics/roadmap/nautilus_adapter/td-position-account-truth-merge/README.md) 已完成。
...
**当前 first action**：继续稳定化并重跑 `20260403__live-ops-truth-snapshot__live-ops-policy-baseline` 的真实 live smoke
