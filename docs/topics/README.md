...
- **排队 topics**：[autopilot-session-management (#2)](autopilot-session-management.md)
- **排队 changes**：[20260413__autopilot-session-management__trajectory-and-drift](../changes/20260413__autopilot-session-management__trajectory-and-drift/plan.md)
...
| --- | --- | --- | --- | --- | --- |
| `autopilot-session-management` | `planned` | `2` | planned | Autopilot Session Management 长期路线 / Autopilot Session Management Topic Roadmap | [README](autopilot-session-management.md) |
