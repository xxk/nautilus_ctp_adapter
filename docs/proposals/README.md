...
| p005 | [p005-adr0010-SendMode安全加固-sendmode-safety-hardening](./p005-adr0010-SendMode安全加固-sendmode-safety-hardening/) | implemented | ADR-0010 WI-5；SendMode enum 成为 guarded paper order send semantics authority，旧 bool 入口仅保留兼容转换 |
