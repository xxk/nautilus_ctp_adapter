# Changes Topic Index 模板 / Changes Topic Index Template

**创建日期**：YYYY-MM-DD
**最后更新**：YYYY-MM-DD
**状态**：draft
**用途**：作为目标项目 `docs/changes_topic/README.md` 的最小索引骨架，集中展示当前 active topic、active change 与 topic 分层规则。
...
| --- | --- | --- | --- |
| `<topic-id-1>` | 进行中 | 当前活动 topic | `docs/changes_topic/roadmap/<domain>/<topic-id-1>/README.md` |
| `<topic-id-2>` | 已完成 | 上一个已完成 topic | `docs/changes_topic/roadmap/<domain>/<topic-id-2>/README.md` |
| `<topic-id-3>` | 未开始 | 后续待激活 topic | `docs/changes_topic/roadmap/<domain>/<topic-id-3>/README.md` 或 `README 待创建` |
