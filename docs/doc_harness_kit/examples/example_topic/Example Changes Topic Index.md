# Changes Topic Index 示例 / Example Changes Topic Index

**创建日期**：2026-04-02
**最后更新**：2026-04-02
**状态**：draft
**用途**：展示目标项目 `docs/changes_topic/README.md` 在填完后应包含哪些稳定区块。
...
1. `docs/changes_topic/roadmap/` 负责长期 topic 路线图。
...
| --- | --- | --- | --- |
| `project-entry` | 进行中 | 当前活动 topic，负责统一运行入口 | `docs/changes_topic/roadmap/project/project-entry/README.md` |
| `project-bootstrap` | 已完成 | 已完成的项目初始化 topic | `docs/changes_topic/roadmap/project/project-bootstrap/README.md` |
| `repo-governance` | 进行中 | 治理辅线 topic，负责入口与文档保鲜 | `docs/changes_topic/roadmap/governance/repo-governance/README.md` |
