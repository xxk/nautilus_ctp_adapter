...
1. [td-position-account-truth-merge](/D:/Nautilus/nautilus_ctp_adapter/docs/changes_topic/roadmap/nautilus_adapter/td-position-account-truth-merge/README.md) 已完成。
...
**当前 first action**：推进 `20260403__live-ops-truth-snapshot__live-ops-policy-baseline`
